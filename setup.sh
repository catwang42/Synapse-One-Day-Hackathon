...
if [ $# -ne 1 ] && [ $# -ne 2 ] && [ $# -ne 3 ]; then
    echo "This setup script will install the Hackthon base architecture and the example Contoso package with test data sets."
    echo ""
...
logfile="hackathon_setup_${datetime}.log"
...
echo "--> Setting up Hackathon (logging detailed setup messages to $logfile)"
echo "--> Setting up Hackathon (logging detailed setup messages to $logfile)" 1>&3

# setup the base architecture
echo "--> Setting up the Hackathon base architecture."
echo "--> Setting up the Hackathon base architecture." 1>&3
...
# install the hackathon framework assets
echo "--> Setting up the Hackathon framework."
echo "--> Setting up the Hackathon framework." 1>&3
...
echo "--> Hackathon setup is complete. Click on this url to work with your new Synapse workspace (via Synapse Studio): $workspace_url"
echo "--> Hackathon setup is complete. Click on this url to work with your new Synapse workspace (via Synapse Studio): $workspace_url" 1>&3
